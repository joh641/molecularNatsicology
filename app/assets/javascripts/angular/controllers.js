...
var molecularnatsicologyControllers = angular.module('molecularnatsicologyControllers', []);

molecularnatsicologyControllers.controller('CourseListCtrl', ['$scope', '$http',
  function($scope, $http) {
    $scope.courses = [];
...
// molecularnatsicologyControllers.controller('CourseDetailCtrl', ['$scope', '$routeParams', 'Course',
//   function($scope, $routeParams, Course) {
//     $scope.course = Course.get({courseId: $routeParams.courseId});
//   }]);

molecularnatsicologyControllers.controller('PlanListCtrl', ['$scope', 
  function($scope) {

  }]);

molecularnatsicologyControllers.controller('PlanDetailCtrl', ['$scope', '$http', '$routeParams', 'Plan',
